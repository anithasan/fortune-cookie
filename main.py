...
def getRandomFortune():
    #list of possiblw fortunes
    fortunes = [
    "I see much code in your future",
    "Consider eating more fortune cookies",
    "You have tamed the mighty python, now you must free the Great Spider's Web!"
    ]
...
class MainHandler(webapp2.RequestHandler):
    def get(self):
        ...
        fortune_paragraph ="<p style=color:blue;>" + fortune_sentence + "</p>"

        lucky_number ="<strong>" + str(random.randint(1,100))+"</strong>"
        number_sentence ='Your lucky number: ' + lucky_number
        number_paragraph = "<p style=color:green;>" + number_sentence +"</p>"
...
app = webapp2.WSGIApplication([('/', MainHandler)], debug=True) #instance, constructors app object
